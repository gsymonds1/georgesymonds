...
//https://docs.google.com/spreadsheets/d/1V389rt574p0RbzM2nbrAq0pw-CRCR1hePuGPoBgZ3Z0
...
content.innerHTML += ""; // Adjust width and height as needed
    ...
    content.innerHTML += "<img src='" + row[9] + "' style='width: 23%; float: right; vertical-align: top; margin-top: -20vh; object-fit: cover; height: 100px; width: 100px;'> "; // image
