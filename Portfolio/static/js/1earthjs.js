...
document.addEventListener("DOMContentLoaded", function() {
    // Trigger the handleMenu function on page load with the initial value
...
//         // You can add more cases or conditions as needed
//         switch (selectedValue) {
//             case 'cyberfeminism':
//                 window.location.href = '/index.html'; // Change the URL accordingly
//                 break;
//             case 'about':
//                 window.location.href = '/about'; // Change the URL accordingly
//                 break;
//             case 'images':
//                 window.location.href = '/images'; // Change the URL accordingly
//                 break;
//             case 'collections':
//                 window.location.href = '/collections'; // Change the URL accordingly
//                 break;
//             case 'search':
//                 window.location.href = '/search'; // Change the URL accordingly
//                 break;
//             default:
