...
function processData(rows) {
    ...
    function displayContent(row) {
        ...
        content.innerHTML += `<div class="innerTableContent"><h2 style="flex: 1; margin: 0; ;vertical-align: top;"><a href='` + row[1] + `' style='text-decoration: none;'>` + row[0] + `</h2><img src="` + row[2] + `" style="flex: 0 0 100px; object-fit: cover; height: 100px; width: 100px;"></div><br><br><br></div>`;
